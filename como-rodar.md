...
- **JDK 21** (definido em `pom.xml`)
- **Maven 3.9+** instalado, **ou** rodar via **IntelliJ IDEA** (não há Maven Wrapper no projeto)
- **Node.js 18+** e **npm**
...
> Em Linux/Mac: `set -a; source .env; set +a && mvn spring-boot:run`
>
> **Sem Maven instalado?** Abra o projeto no **IntelliJ IDEA** e rode a classe
> `EmailServiceApplication` (defina as variáveis do `.env` em *Run/Debug Configurations →
